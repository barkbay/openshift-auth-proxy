...
var config = require('yargs')
  ...
  .options({
    'listen-port': {
      ...
      describe: 'Comma sperated allowed group of users, also set OAP_USERS_IMPERSONATE_USER',
      default: process.env.OAP_IMPERSONATE_USERS_ALLOWED || ''
    }, impersonate_identity: {
      describe: 'Identity to use for OAP_IMPERSONATE_USERS_ALLOWED',
      default: process.env.OAP_IMPERSONATE_USER || ''
